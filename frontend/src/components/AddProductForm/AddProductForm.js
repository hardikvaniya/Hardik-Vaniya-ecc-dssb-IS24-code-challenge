...
const AddProductForm = ({ closeModal, fetchProductData, data, isNewProduct }) => {
        ...
        <Container>
            ...
            <Grid item xs={2}>
                    <IconButton onClick={closeModal}>
                        <CloseModal className={classes.closeButton} />
                    </IconButton>
                </Grid>
                <Grid item xs mb={2}>
                            ...
                            >
                                ...
                                {formData.developers?.length > 1 && (
                                    <Grid item>
                                        ...
                                        >
                                            <Delete fontSize="inherit" style={{ color: 'black' }}/>
                                        </IconButton>
                                    </Grid>
                                )}
                            </Grid>
